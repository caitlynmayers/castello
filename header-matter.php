	...
	<body <?php body_class(); ?>>
	 ...
	 viewBox="0 0 40 40" enable-background="new 0 0 40 40" xml:space="preserve">
				...
				<section class="interior reversed">
					...
					<h1>matter | ˈmatər |</h1>
					<p>1. physical substance in general, as distinct from mind and spirit; (in physics) that which occupies space and possesses rest mass, esp. as distinct from energy: <em>the structure and properties of matter</em>.<br /> • a substance or material: <em>organic matter</em> | <em>vegetable matter</em>.<br /> • written or printed material: <em>reading matter</em>.</p>

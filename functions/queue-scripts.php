...
//	Enqueued Styles
	...
	function primary_styles() {
		...
		if (!is_admin()) {
			wp_register_style('primary-styles', get_stylesheet_directory_uri() . '/dist/css/app.css', false, $random);
...
//	Enqueued Scripts
	...
	function load_theme_scripts() {
		...
		if (!is_admin()) {
			...
			wp_register_script('jquery', get_stylesheet_directory_uri() . '/dist/js/jquery.js', array(), false, true);

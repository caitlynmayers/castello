...
custom post types for WordPress. To initialize your post type,
create a post_type_init instance within the create_post_types
function. Simply declare all of the settings required for your
post_type.

NOTE: Do not forget to include 'taxonomies' setting if custom 
taxonomies have been setup for any post types created.
...
***/
    ...
    function post_type_init($settings) {
        ...
        $args = array(
            'labels'                =>  $labels,
            'capability_type'       =>  (!empty($settings['capability_type']) ? $settings['behavior'] : 'post'),

...
<div class="category-wrapper">
	<div class="list">
		<div class="items matter">
			<?php
				$array_out = array();
				$taxonomy = 'matter-category';
				$terms = wp_get_post_terms( $post->ID, $taxonomy, array( "fields" => "all" ) );
				if( $terms ) {
					echo '<ul>';
					echo '<li><a href="/wordpress/matter">All</a></li>';
	...
	<?php $this_page = new Post(get_the_ID()); ?>
		...
		<?php if ( has_post_thumbnail() ) : ?>
			...
			<div class="feature-img">
				...
				<?php $term = wp_get_post_terms( $post->ID, 'matter-category', array("fields" => "slugs" )); ?>
			
				<img src="<?php bloginfo('url'); ?>/wp-content/themes/castello/img/<?php echo $term[0]; ?>.png" alt="<?php echo $term[0]; ?>" />
